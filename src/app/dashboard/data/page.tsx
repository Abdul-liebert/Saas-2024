...
export default function Data() {
  ...
  const imageCards = [
    {
      ...
      image: "/img/kelas.jpg",
      title: "Kelas",
      description: "Tempat untuk belajar bagi para siswa",
    },
    {
      id: 2,
      image: "/img/lab.png",
      title: "Lab Komputer",
      description: "Tempat untuk belajar komputer bagi para siswa",
    },
    {
      id: 3,
      image: "/img/Ruang-Makan.png",
      title: "Ruang Makan",
      description: "Tempat untuk makan bagi para siswa",
    },
    {
      id: 4,
      image: "/img/kamar.png",
      title: "Kamar",
      description: "Tempat untuk istirahat bagi para siswa",
    },
  ];
  ...
  return (
    <div>
      ...
      <section className="grid grid-cols-1 gap-4 mt-5 lg:grid-cols-4">
        {imageCards.map((card) => (
          <CardWithImage
            key={card.id}
            image={card.image}
