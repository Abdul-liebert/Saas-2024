  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center">
      ...
      <main className="flex-grow flex flex-col items-center mt-10">
        ...
        <div className="mt-10">
          <a href="/dashboard">
            <button className="px-8 py-4 text-lg text-white bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-105">
              Ke Dashboard
            </button>
          </a>
        </div>
